...
const CampDetailsSection = () => {
  ...
  const camps = [{
    ...
    description: "La reconocida metodología de entrenamiento de IMG Academy combina instrucción deportiva de élite con trabajo en grupo de fuerza, velocidad y rendimiento mental.",
    ...
    description: "Diseñado para atletas que buscan potenciar su fuerza, velocidad, resistencia mental u otras áreas clave de rendimiento. Cada semana eliges una especialización, con entrenamientos diarios.",
    bgColor: "bg-blue-400"
  }, {
    ...
    description: "Pensado para atletas que desean un entrenamiento más personalizado y enfocado en perfeccionar aspectos específicos de su juego.",
    ...
    description: "Creado para atletas que buscan la experiencia de entrenamiento definitiva para transformar todos los aspectos de su desarrollo y rendimiento.",
